...
<div>
    <div class="container">
        <div class="row">
            <div class="col-2">
                ${err }
                <s:form id="RegForm" method="post" modelAttribute="user" action="${pageContext.request.contextPath }/user/register">
                    <p>Username</p>
                    <s:input path="username" required="required"/>
                    <p>Password</p>
                    <s:input path="password" required="required" autocomplete="off" />
                    <p>Email</p>
...
<footer class="w3-container w3-padding-64 w3-center w3-opacity">
    ...
    &copy; 2023 - Yaroslav Tsvyk - <a href="#">Privacy</a>
</footer>
